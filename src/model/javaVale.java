...
/*public class Province {
    ...
    public Province(int id, String name, Date createdDateTime, String createdBy,
                    Date updatedDateTime, String updatedBy, int countryId) {
        this.id = id;
        this.name = name;
        this.createdDateTime = createdDateTime;
        this.createdBy = createdBy;
...
/*public class Country {
    ...
    public Country(int id, String name, Date createdDateTime, String createdBy,
                   Date updatedDateTime, String updatedBy) {
        this.id = id;
        this.name = name;
        this.createdDateTime = createdDateTime;
        this.createdBy = createdBy;
...
/*public class UserTypes {
    ...
    public UserTypes(int id, String name, String createdBy, Date createdDate,
...
/*public class IdType {
    ...
    public IdType(int id, String name, String createdBy, Date createdDate,
                  String updatedBy, Date updatedDate) {
        this.id = id;
        this.name = name;
        this.createdBy = createdBy;
...
/*public class Genders {
    ...
    public Genders(int id, String name, String createdBy, Date createdDate,
                   String updatedBy, Date updatedDate) {
        this.id = id;
        this.name = name;
        this.createdBy = createdBy;
